...
public enum CommandType {
    ...
    ttl(Ttl::new), get(Get::new), quit(Quit::new), setnx(SetNx::new), del(Del::new),
    lpop(Lpop::new), lpush(Lpush::new), lrange(Lrange::new), lrem(Lrem::new), rpush(Rpush::new), rpop(Rpop::new), sadd(Sadd::new),
